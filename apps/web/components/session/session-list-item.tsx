...
function SessionListEmptyState() {
  return (
    <div className="rounded-lg border border-dashed border-gray-300 bg-gray-50 p-8 text-center dark:border-gray-700 dark:bg-gray-900">
      ...
      <h3 className="mt-4 text-sm font-medium text-gray-900 dark:text-gray-100">No sessions yet</h3>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Create your first session to start building with AI.</p>
    </div>
  )
}
...
function DeleteSessionButton({
  ...
  return (
    <Button
      ...
      disabled={deletingId === sessionId || isPending}
...
export { SessionListEmptyState, SessionListItem }
